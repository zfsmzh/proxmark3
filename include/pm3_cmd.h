...
#define FLAG_SET_UID_IN_EMUL(flags)                            \
    {                                                          \
        flags = (flags & (~FLAG_MASK_UID)) | FLAG_UID_IN_EMUL; \
    }
...
#define FLAG_SET_MF_SIZE(flags, size)                                                                                                                                                                      \
    {                                                                                                                                                                                                      \
        flags = (flags & (~FLAG_MASK_MF_SIZE)) |                                                                                                                                                           \
                (size == MIFARE_MINI_MAX_BYTES ? FLAG_MF_MINI : (size == MIFARE_1K_MAX_BYTES ? FLAG_MF_1K : (size == MIFARE_2K_MAX_BYTES ? FLAG_MF_2K : (size == MIFARE_4K_MAX_BYTES ? FLAG_MF_4K : 0)))); \
    }
